function OLD_mm_2021_draw(gamma)
...
Chassis_v=repmat(r_I_C,1,length(Chassis))+Chassis';
WheelR_v=repmat(r_I_R,1,length(WheelR))+WheelR';
WheelL_v=repmat(r_I_L,1,length(WheelL))+WheelL';

Link1_v=repmat(r_I_1,1,length(Link1))+Link1';

Link2R_v=repmat(r_I_2R,1,length(Link2R))+Link2R';
Link3R_v=repmat(r_I_3R,1,length(Link3R))+Link3R';
Link4R_v=repmat(r_I_4R,1,length(Link4R))+Link4R';
Link5R_v=repmat(r_I_5R,1,length(Link5R))+Link5R';
Link6R_v=repmat(r_I_6R,1,length(Link6R))+Link6R';

Link2L_v=repmat(r_I_2L,1,length(Link2L))+Link2L';
Link3L_v=repmat(r_I_3L,1,length(Link3L))+Link3L';
Link4L_v=repmat(r_I_4L,1,length(Link4L))+Link4L';
Link5L_v=repmat(r_I_5L,1,length(Link5L))+Link5L';
Link6L_v=repmat(r_I_6L,1,length(Link6L))+Link6L';
